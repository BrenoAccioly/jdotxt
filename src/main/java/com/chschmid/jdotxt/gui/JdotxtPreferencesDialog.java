...
public class JdotxtPreferencesDialog extends JDialog {
    ...
    private Box okCancelBar;
    private JdotxtImageButton buttonSettings;
    private JdotxtImageButton buttonHelp;
    private JdotxtImageButton buttonAbout;
    private JPanel mainPanel;
    private JComboBox<String> language;

    // Settings controls
    private JTextField directory;
    private JCheckBox cbCompactMode;
    private JCheckBox cbProjectsPanel;
    private JCheckBox cbContextsPanel;
    private JCheckBox cbSwitchPanels;
    private JCheckBox cbPrependMetadata;
    private JCheckBox cbCopyMetadata;
    ...
    private JRadioButton crAsk;
    private JRadioButton crLocal;
    private JRadioButton crRemote;
